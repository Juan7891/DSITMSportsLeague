        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TournamentSponsorId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TournamentSponsors_TournamentSponsors_TournamentSponsorId",
                        column: x => x.TournamentSponsorId,
                        principalTable: "TournamentSponsors",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TournamentSponsors_TournamentSponsorId",
                table: "TournamentSponsors",
                column: "TournamentSponsorId");
